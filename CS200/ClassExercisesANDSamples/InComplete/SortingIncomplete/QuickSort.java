...
public class QuickSort {
  ...
  private static < T extends Comparable < T >> void quickSort(T[] table,
                                               int first,
                                               int last) {
    if (first < last) { // There is more than 1 data item to be sorted.
      // Partition the table.
  ...
  private static < T extends Comparable < T >> int partition(T[] table,
    ...
    //COMPLETE REST OF METHOD ***************************************************************
    do {

      // As long as up < last and table[up] < pivot ... increase up

      // As long as down > first and table[down] > pivot ... decrease down
