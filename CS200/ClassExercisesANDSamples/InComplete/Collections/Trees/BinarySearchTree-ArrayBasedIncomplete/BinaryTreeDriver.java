...
public class BinaryTreeDriver {
  ...
  public static void main(String args[]) {
    BSTInterface<Integer> bst = new BinarySearchTree<Integer>();
     ...
     System.out.println();     
     System.out.println("******************************************************************");    
     System.out.println("bst.remove(4) : " + bst.remove(4));
     System.out.println(bst);     
     System.out.println("******************************************************************");
     System.out.println("bst.remove(3) : " + bst.remove(3));
     System.out.println(bst);    
     System.out.println("******************************************************************");
     System.out.println("bst.remove(20) : " + bst.remove(20));
     System.out.println(bst); 
     System.out.println("******************************************************************");
     System.out.println("bst.remove(15) : " + bst.remove(15));
     System.out.println(bst);
     System.out.println("******************************************************************");
     System.out.println("bst.remove(15) : " + bst.remove(15));
     System.out.println(bst);    
