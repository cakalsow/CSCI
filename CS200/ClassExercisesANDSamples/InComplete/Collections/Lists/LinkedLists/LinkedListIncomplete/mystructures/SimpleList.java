...
public interface SimpleList <E> {
   ...
   * 
   * finds and removes the node with a value equal to parameter outData and returns 
   ...
   * This method is recursive
   * 
   * finds and returns the element at specified index if such an index is valid 
   ...
   * This method is recursive
   * 
   * returns a string containing the contents of the list in reverse order: E.g., 
   * for list 1-->2-->3-->|TERMINAL| it should return 3 2 1
   ...
   * This method is recursive
   * 
   * returns the index (starting from 0) of the node containing element 
