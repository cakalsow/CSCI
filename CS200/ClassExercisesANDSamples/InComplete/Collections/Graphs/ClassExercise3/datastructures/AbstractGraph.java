...
public abstract class AbstractGraph implements Graph {
   ...
   *   is the weight.
   * @param fileSC The Scanner object that is connected to the 
   *        file that contains the data
   * @throws IOException if an I/O error occurs
   */
  public void loadEdgesFromFile(Scanner fileSC) throws IOException {
    String line;
   ...
   * @param sc The Scanner to read data from file
   ...
   *         nor "List"
   */
  public static Graph createGraph(Scanner sC, boolean isDirected, String type) 
    throws IOException {
    ...
    returnValue.loadEdgesFromFile(sC);
    return returnValue;
  }
}
