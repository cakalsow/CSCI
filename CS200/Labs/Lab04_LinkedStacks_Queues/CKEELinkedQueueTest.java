...
/**
 * A JUnit test case class for class CKEELinkedQueue  
 * 
 * @author Imad M Rahal
 * @version January 27, 2015
 */
public class CKEELinkedQueueTest{
  
  private ZHQueue<Integer> notEmptyQueue, emptyQueue;
  
  @Before
  public void init(){
    notEmptyQueue = new CKEELinkedQueue<Integer>();
    emptyQueue = new CKEELinkedQueue<Integer>();
