...
/**
 * A JUnit test case class for class CKEELinkedStack  
 * 
 * @author Imad M Rahal
 * @version 09/20/2017
 */
public class CKEELinkedStackTest {
  
  private ZHStack<Integer> notEmptyStack, emptyStack;
  
  @Before
  public void init(){
    notEmptyStack = new CKEELinkedStack<Integer>();
    emptyStack = new CKEELinkedStack<Integer>();
